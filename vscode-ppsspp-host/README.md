...
Instale este VSIX **localmente no VS Code do Windows**. A extensão TBF principal
fica no Dev Container e executa a ferramenta em Linux. Este componente local
somente inicia e encerra o PPSSPP, sem PowerShell, rede ou servidores HTTP.
