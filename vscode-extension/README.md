...
automaticamente pelo comando pós-conexão. Configure o caminho do emulador e da
ISO para usar o PPSSPP Host. O editor chama Node diretamente no container; o
componente de interface abre somente o emulador.
